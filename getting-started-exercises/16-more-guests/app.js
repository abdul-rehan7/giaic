...
let guests = ["Bill Gates", "Stephen Hawkings", "Steve Jobs", "Barack Obama"];
let cannotattend = "Stephen Hawkings";
let newguest = "Tim Cook";
let message = "";
console.log(guests);
...
// Guest in start 
let guestbigg = "Elon Musk";
guests.unshift(guestbigg);
console.log(guests);
// Guest in middle
let guestmid = "Warren Buffet";
